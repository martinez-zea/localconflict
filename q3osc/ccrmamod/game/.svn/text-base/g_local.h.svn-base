...
// ORIGINAL clientPersistant_t - rkh
//------------------------------------
/*
typedef struct {
...
#define fudi_send_cached_int(clientno,val,cachefield,label) if ((val)!=osc_cache[clientno].cachefield) { osc_send_int((clientno),label,(val)); (osc_cache[clientno].cachefield=(val)); }
#endif
...
extern  vmCvar_t        osc_port;
extern  vmCvar_t        osc_open;
